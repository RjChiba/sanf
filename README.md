...
```bash
IIIF_SOURCE_ROOT=/path/to/images uvicorn app.main:create_app --factory --reload
```
...
```python
from app import IIIFServerSettings, LocalFileConnector
...
```python
from app import create_app, IIIFServerSettings, LocalFileConnector
from pathlib import Path
...
from app import create_iiif_router, IIIFServerSettings, LocalFileConnector
from pathlib import Path
